...
//             ripple.className = "waves-ripple";
//             if (elem.className.isNotEmpty() && (elem.className).indexOf("waves") > -1) {
...
//                 }
//                 win = getWindow(doc);
//                 var scale       = 'scale('+((elem.clientWidth / 100) * 10)+')';
//                 var pos = {
...
//                 //console.log(e, rippleStyle.top);
//                /* ripple.setAttribute("style", "top:" + relativeY
//                     + "px;left:" + relativeX + "px;");*/
...
//                 ripple.setAttribute('data-scale', scale);
//                 ripple.setAttribute('data-x', relativeY.top);
//                 ripple.setAttribute('data-y', relativeX.left);
